  ...
  return (
    <main className="relative flex min-h-svh flex-col justify-end px-6 pb-16 pt-32 md:px-12 lg:px-20">
      ...
      <div className="mt-10 flex flex-wrap gap-4">
        <Link
          href="/"
          className="border border-[var(--signal)] bg-[var(--signal)] px-6 py-3 font-mono text-xs tracking-[0.2em] text-[var(--signal-foreground)] uppercase transition-opacity hover:opacity-90"
        >
          Return home
        </Link>
        <Link
          href="/playground"
          className="border border-[var(--border)] px-6 py-3 font-mono text-xs tracking-[0.2em] text-[var(--muted-foreground)] uppercase transition-colors hover:border-[var(--signal)] hover:text-[var(--signal)]"
        >
          Try the lab
        </Link>
      </div>
