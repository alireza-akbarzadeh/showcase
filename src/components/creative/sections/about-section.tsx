        ...
        <div className="mt-10 overflow-x-auto pb-4">
          ...
          >
            {CAREER_JOURNEY.map((stop, i) => (
              ...
              >
                <span
                  className="absolute top-0 left-6 h-2 w-2 -translate-y-1/2 rounded-full bg-[var(--signal)]"
                  aria-hidden="true"
                />
                <p className="font-mono text-[10px] tracking-[0.22em] text-[var(--muted-foreground)] uppercase">
                  {stop.year}
                </p>
                <h4 className="font-display mt-3 text-2xl tracking-[-0.02em]">
                  {stop.role}
                </h4>
                <p className="mt-1 text-sm text-[var(--signal)]">{stop.place}</p>
                <p className="mt-5 text-[var(--foreground)]">
                  <span className="font-mono text-[10px] tracking-[0.18em] text-[var(--muted-foreground)] uppercase">
                    Win ·{" "}
                  </span>
                  {stop.achievement}
                </p>
